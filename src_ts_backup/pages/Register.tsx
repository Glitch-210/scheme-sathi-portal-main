            ...
            {step === 'form' ? (
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                  ...
                  />
                  {errors.confirmMpin && (
                    <p className="text-sm text-destructive mt-1">{errors.confirmMpin.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <select
                    {...register('language')}
                    className="flex h-12 w-full rounded-lg border-2 border-input bg-card px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-primary"
                  >
