...
const Login = () => {
  ...
  const [loginMethod, setLoginMethod] = useState<'mpin' | 'otp'>('mpin');
  ...
  const onSubmitMpin = (data: LoginForm) => {
        ...
        <Card className="w-full max-w-md animate-fade-in">
          ...
          <CardContent>
            ...
            <div className="flex gap-2 mb-6">
              <Button
                variant={loginMethod === 'mpin' ? 'default' : 'secondary'}
                className="flex-1"
                onClick={() => {
                  setLoginMethod('mpin');
                  setOtpStep('mobile');
              ...
              <Button
                variant={loginMethod === 'otp' ? 'default' : 'secondary'}
                className="flex-1"
            ...
            {loginMethod === 'mpin' ? (
              <form onSubmit={handleSubmit(onSubmitMpin)} className="space-y-4">
                ...
                <div>
                  ...
                  />
                  {errors.mpin && (
                    <p className="text-sm text-destructive mt-1">{errors.mpin.message}</p>
                  )}
                </div>
                ...
                <button
                  ...
                  onClick={() => toast.info('Demo: MPIN reset not available')}
                >
                  {t('forgotMpin')}
                </button>
