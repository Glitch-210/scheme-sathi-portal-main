...
const Profile = () => {
  ...
  const [activeSection, setActiveSection] = useState<'profile' | 'mpin' | 'language'>('profile');
    ...
    <Layout>
      <div className="container py-6 md:py-10 max-w-2xl">
        ...
        <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
          ...
          <Button
            variant={activeSection === 'mpin' ? 'default' : 'secondary'}
          ...
          <Button
            variant={activeSection === 'language' ? 'default' : 'secondary'}
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setMpinData((prev) => ({ ...prev, currentMpin: e.target.value }))
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setMpinData((prev) => ({ ...prev, newMpin: e.target.value }))
                  }
                  placeholder="4-6 digit new MPIN"
                  maxLength={6}
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setMpinData((prev) => ({ ...prev, confirmMpin: e.target.value }))
                  }
